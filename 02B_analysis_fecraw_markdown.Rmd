...
```{r zipdataprep, include=FALSE}

# Prepare zipcode data ####
...
irs_zip_raw <- read_csv("zip_data/16zpallagi.csv", 
...
zipcompare <- left_join(zipcompare, irs_zips_agi_grouped, by = c("zip_code" = "zipcode"))
